 ...
 *
 */
public class StringStepCapitalizer <V extends Milestone<String>> extends CallableStep<String, V> {
    
    public StringStepCapitalizer(int stepId, int previousStepId, boolean finalStep) {
